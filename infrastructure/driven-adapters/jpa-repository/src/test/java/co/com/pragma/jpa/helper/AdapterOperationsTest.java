...
import co.com.pragma.jpa.adapter.JPARepositoryRegisterAdapter;
...
class AdapterOperationsTest {
    ...
    @Mock
    private JPARegisterRepository repository;

    @Mock
    private ObjectMapper objectMapper;

    private JPARepositoryRegisterAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new JPARepositoryRegisterAdapter(repository, objectMapper);
    }
